        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-400 md:text-xl">
              Unlock the power of our cutting-edge tools and services to transform your online experience.
            </p>
            <form className="flex max-w-md space-x-2">
              <Input
                className="flex-1 rounded-md bg-gray-800 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500"
